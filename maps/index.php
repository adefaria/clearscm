...
<body>
  ...
  <div class="heading">
    <h2 class="header">Mail Authorization and Permission System</h2>
    <h3 class="header">Spam Elimination System</h3>
  </div>
  ...
  <div class="content">
    ...
    <form method="post" action="php/main.php" enctype="application/x-www-form-urlencoded">
