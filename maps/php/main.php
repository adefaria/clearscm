...
<body>
  ...
  <div class="content">
    ...
    <p>
      This is the main or home page of MAPS. To the left you see a menu
      of choices that you can use to explore MAPS functionality. <a href="/maps/bin/stats.cgi">Statistics</a> gives you
      a view of the spam that MAPS has been trapping for you in tabular format. You can
      use <a href="/maps/bin/editprofile.cgi">Edit Profile</a> to change
      your profile information or to change your password.
    </p>

    <p>
      You can manage your <a href="/maps/php/list.php?type=white">White</a>,
      <a href="/maps/php/list.php?type=black">Black</a> and <a href="/maps/php/list.php?type=null">Null</a> lists
      although MAPS seeks to put that responsibility on those who wish to email you. You
