  ...
  <div class="content" style="padding-top: 6px;">
    ...
    <form method="post" action="/maps/bin/processaction.cgi" name="list">
      ...
      <div class="toolbar" align="center">
        ...
        <input type="submit" name="action" value="Modify" onclick="return CheckAtLeast1Checked (document.list);">
        <input type="submit" name="action" value="Reset" onclick="return ClearAll (document.list);">
