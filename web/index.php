...
<head>
  ...
  <title>ClearSCM - Andrew DeFaria</title>
  ...
  <div id="page">
    <div id="content">
      <div id="contentWrapper2">
        <div id="main">
          <?php start_box("cs3"); ?>
          <p>We provide top notch talent for your <abbr title="Source Configuration Management">SCM</abbr> projects.
            With over 10
          ...
          <h2>Our services</h2>
          <img src="/Images/BMLeft.jpg" width="250" height="165" style="float:left;border:1;padding:5px;" />
        ...
        <div id="supporting">
          ...
          <p>Utilizing top tier professional tools such as <a
            ...
            <a href="http://www.ibm.com/software/awdtools/clearcase/multisite/index.html">Multisite</a>,
            <a href="http://www.ibm.com/software/awdtools/clearquest/index.html">Clearquest</a>
            as well as various Open Source tools such as <abbr title="Concurrent Versions System: A free and commonly
            used Open Source SCM system">CVS</abbr> we work with your
            company to build professional, customized solutions to
            your <abbr title="Source Configuration Management">SCM</abbr> needs.
          </p>
          <?php end_box(); ?>
      ...
      <div id="contentWrapper1">
        <div id="related">
          ...
          <p>Whether large or small, today's software is more
            ...
            code from inception to release.... <a href="/sysadm">(more)</a></p>
          <?php end_box(); ?>
          ...
          <p>Over the years there have been many languages that have
            ...
            larger, customized solutions for your business...<a href="/sysadm">(more)</a></p>
          <?php end_box(); ?>
        </div> <!-- related -->
      </div> <!-- contentWrapper1 -->
    </div> <!-- content -->
